...
const DiseaseCard: React.FC<Props> = memo(
  ({ diseaseName, cropName, confidence, status, imageUri, onPress }) => {
    ...
    return (
      <TouchableOpacity
        style={[styles.card, { backgroundColor: C.CARD_BG, borderColor: C.BORDER }]}
        onPress={onPress}
        activeOpacity={0.75}
        disabled={!onPress}
      >
...
const styles = StyleSheet.create({
  ...
  diseaseName: { ...Fonts.label, marginBottom: 2 },
  cropName: { ...Fonts.caption, marginBottom: 4 },
  statusPill: { alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 2, borderRadius: BorderRadius.pill },
