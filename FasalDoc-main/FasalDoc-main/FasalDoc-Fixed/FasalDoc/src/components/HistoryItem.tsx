...
const CROP_EMOJI: Record<string, string> = {
  Apple: '🍎', Maize: '🌽', Tomato: '🍅', Potato: '🥔',
  Grape: '🍇', Wheat: '🌾', Rice: '🌾', Cotton: '🌿',
  Pepper: '🫑', Peach: '🍑', Orange: '🍊', Squash: '🎃',
  Strawberry: '🍓', Cherry: '🍒', Soybean: '🌱', Blueberry: '🫐',
  Raspberry: '🫐', Default: '🌿',
};

const HistoryItem: React.FC<Props> = memo(({ item, onPress }) => {
...
const styles = StyleSheet.create({
  container: {
    ...
    paddingVertical: Spacing.md, gap: Spacing.md, borderBottomWidth: 0.5,
  },
  thumbnail: { width: 44, height: 44, borderRadius: 10, alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  emoji: { fontSize: 22 },
  meta: { flex: 1 },
  diseaseName: { ...Fonts.subheading, marginBottom: 2 },
  subtitle: { ...Fonts.caption },
  statusPill: { paddingHorizontal: Spacing.sm, paddingVertical: 3, borderRadius: BorderRadius.pill, flexShrink: 0 },
