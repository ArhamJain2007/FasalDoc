...
const TreatmentTag: React.FC<Props> = memo(({ label, type }) => {
...
const styles = StyleSheet.create({
  tag: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: BorderRadius.pill, margin: 4 },
  label: { ...Fonts.caption, fontWeight: '500' },
});
